    ...
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16">
      <div className=" flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0">
        <div>
          ...
          Ku dawo da lafiya cikin sauƙi da tabbaci tare da magungunanmu na gargajiya masu inganci,
           waɗanda aka tsara don dawo da kuzari, kwanciyar hankali, da rayuwa mai armashi!
